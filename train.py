...
from DataPreProcess import train_data,val_data,test_data
...
def main(train_d, dev_d , target_dir,
         epochs=10,
         batch_size=1 ,
         lr=0.01,
         patience=3,
    ...
    train_data = DataGeneration(bert_tokenizer,train_d)
    train_loader = DataLoader(train_data, shuffle=True, batch_size=batch_size)
    print("\t* Loading validation data...")
    dev_data = DataGeneration(bert_tokenizer, dev_d)
...
if __name__ == "__main__":
    main(train_data, val_data, "models")
